/**
 * Shared FlowStory in-document shell (overall map + v4 scenario tabs).
 */
...
/** v4 Overall Demo step 0 — in-card shell without flow select (step chosen in nav). */
...
export function wireInDocOverlayClose() {
  ...
  if (!overlay || overlay.dataset.nrV4Wired) return;
  overlay.dataset.nrV4Wired = "1";
